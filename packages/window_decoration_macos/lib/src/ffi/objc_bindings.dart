...
class ObjCBindings {
  ...
  static final ObjCObjectPointer Function(
    ObjCObjectPointer,
    ObjCSelectorPointer,
  ) objc_msgSend = _objc.lookupFunction<
  ...
  static final void Function(ObjCObjectPointer, ObjCSelectorPointer, int)
      objc_msgSend_void_int = _objc.lookupFunction<
  ...
  static final void Function(ObjCObjectPointer, ObjCSelectorPointer, bool)
      objc_msgSend_void_bool = _objc.lookupFunction<
  ...
  static final void Function(ObjCObjectPointer, ObjCSelectorPointer, double)
      objc_msgSend_void_double = _objc.lookupFunction<
  ...
  static final void Function(
    ...
    ObjCSelectorPointer,
    ObjCObjectPointer,
  ) objc_msgSend_void_obj = _objc.lookupFunction<
        Void Function(
          ObjCObjectPointer,
          ObjCSelectorPointer,
          ObjCObjectPointer,
  ...
  static final int Function(ObjCObjectPointer, ObjCSelectorPointer)
      objc_msgSend_int = _objc.lookupFunction<
  ...
  static final double Function(ObjCObjectPointer, ObjCSelectorPointer)
      objc_msgSend_double = _objc.lookupFunction<
  ...
  static final ObjCObjectPointer Function(
    ...
    ObjCSelectorPointer,
    int,
  ) objc_msgSend_obj_int = _objc.lookupFunction<
  ...
  static final ObjCObjectPointer Function(
    ...
    double,
    double,
  ) objc_msgSend_obj_4doubles = _objc.lookupFunction<
        ObjCObjectPointer Function(
          ObjCObjectPointer,
          ObjCSelectorPointer,
          Double,
  ...
  static NSRect objc_msgSend_stret_nsrect(
    ...
    final getFrame = _objc.lookupFunction<
  ...
  static final void Function(
    ...
    Pointer<NSRect>,
    bool,
  ) objc_msgSend_void_rect_bool = _objc.lookupFunction<
        Void Function(
          ObjCObjectPointer,
          ObjCSelectorPointer,
          Pointer<NSRect>,
