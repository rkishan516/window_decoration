...
class WindowDecorationWindows extends WindowDecorationPlatform {
  ...
  Future<void> center() async {
    ...
    try {
      ...
      final screenWidth =
          Win32Bindings.getSystemMetrics(Win32Bindings.SM_CXSCREEN);
      final screenHeight =
          Win32Bindings.getSystemMetrics(Win32Bindings.SM_CYSCREEN);
  ...
  Future<void> setOpacity(double opacity) async {
    ...
    final currentStyle =
        Win32Bindings.getWindowLongPtr(_hwnd, Win32Bindings.GWL_EXSTYLE);
  ...
  void _restoreStandardTitleBar() {
    ...
    final currentStyle = Win32Bindings.getWindowLongPtr(_hwnd, Win32Bindings.GWL_STYLE);
  ...
  void _hideWindowFrame() {
    ...
    // Remove caption, system menu, and borders but keep resizable
    final newStyle = (currentStyle & ~(Win32Bindings.WS_CAPTION | Win32Bindings.WS_SYSMENU)) |
        Win32Bindings.WS_THICKFRAME;
